...
import cn.cloudx.importdata.entity.*;
import cn.cloudx.importdata.repository.*;
...
public class ImportDataToDataBase {
    ...
    @Autowired
    public ImportDataToDataBase(OrgStructureRepository orgStructureRepository, EmailRepository emailRepository, GroupUserRepository groupUserRepository, PersonRepository personRepository, PhoneRepository phoneRepository,
